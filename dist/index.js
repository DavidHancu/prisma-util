...
createSubCommand(db, "push")
    ...
    if (options.H) {
        new MessageBuilder()
            ...
            .withSection("Examples", [chalk.gray("Ignore data loss warnings"), `${chalk.gray("$")} prisma-util db push --accept-data-loss`
        ])
            .show();
        return;
    }
...
const migrate = program
    ...
    new MessageBuilder()
        ...
        .withSection("Commands for development", [`  ${chalk.gray("dev")}    Create a migration from changes in Prisma schema, apply it to the database\n           trigger generators (e.g. Prisma Client)`,
        `${chalk.gray("reset")}    Reset your database and apply all migrations, all data will be lost`
    ])
        .withSection("Commands for production/staging", [` ${chalk.gray("deploy")}    Apply pending migrations to the database`,
        ...
        .withSection("Commands for any stage", [`${chalk.gray("diff")}    Compare the database schema from two arbitrary sources`
    ])
        .withSection("Options", [`${chalk.gray("-h, --help")}    Display this help message`])
        .withSection("Examples", [chalk.gray("Create a migration from changes in Prisma schema, apply it to the database, trigger generators (e.g. Prisma Client)"), `${chalk.gray("$")} prisma-util migrate dev`, "",
...
createSubCommand(migrate, "reset")
    ...
    if (options.H) {
        new MessageBuilder()
            ...
            .withSection("Examples", [chalk.gray("Reset your database and apply all migrations, all data will be lost"), `${chalk.gray("$")} prisma-util migrate reset`, "",
...
program
    ...
    if (options.H) {
        new MessageBuilder()
            ...
            .withSection("Examples", [chalk.gray("Start Studio on the default port"), `${chalk.gray("$")} prisma-util studio`, "",
...
// Sub command helper
function createSubCommand(command, nameAndArgs) {
